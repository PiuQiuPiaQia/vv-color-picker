<template>
    <div class="container">
        ...
        <div v-show="isSucking" class="donut"></div>
    </div>
</template>
...
export default {
    ...
    methods: {
        ...
        async suckColor(dom) {
            ...
            this.suckerPreview.style.display = "none";
            ...
            this.suckerPreview.addEventListener("mousedown", (e) => {
                e.stopPropagation();
                e.preventDefault();
            });
        },
...
.container {
    ...
    .donut {
        ...
        border-left-color: rgba(21, 147, 255, 0.5);
        border-radius: 50%;
        width: 70%;
        height: 70%;
